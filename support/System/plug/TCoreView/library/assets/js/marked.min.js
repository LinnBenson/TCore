...
renderer.codespan = ({ text }) => {
    return `<code class="codeBlock copy" data-clipboard-text="${tc.md.protect( text )}">${tc.md.protect( text )}</code>`;
};
renderer.code = ({ text }) => {
    return `
        <div class="showCode codeBlock">
            <div class="showCodeHeader">
                ...
                <div></div>
                <div></div>
                <i class="bi-copy copy" data-clipboard-text="${tc.md.protect( text )}"></i>
            </div>
            <div class="showCodeContent">
                <pre class="code">${tc.md.protect( text )}</pre>
            </div>
        </div>
    `;
};
renderer.image = function({ href, text }) {
    return `
        <div class="showImg" onClick="unit.checkBig( \`${tc.md.protect( href )}\` )">
            <img src="${href}" alt="${tc.md.protect( text )}" />
